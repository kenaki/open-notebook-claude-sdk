...
| [004](004-verify-summarize-output-bounds.md) | Verify silently truncates large sections; summaries ~3x longer than consumed; verify re-proofs the book 2.6x over | correctness + efficiency | high | open (queue paused; orphan-storm half fixed in `60363df`) | `commands/verify_commands.py`, `commands/summary_commands.py` | 2026-07-09 |
