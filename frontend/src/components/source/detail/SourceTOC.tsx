  ...
  return (
    <div>
      <div
        ...
        className={cn(
          'flex items-center gap-1.5 rounded-md px-2 py-1.5 text-sm cursor-pointer hover:bg-muted transition-colors',
 ...
 */
export function SourceTOC({ sections, activeSectionId, onSectionClick }: SourceTOCProps) {
