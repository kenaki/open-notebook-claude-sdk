export const zhTW = {
  ...
  gallery: {
    ...
    noResults: "沒有符合搜尋的對話。",
    editTags: "編輯標籤",
    tagInputPlaceholder: "新增標籤…",
    clearFilters: "清除篩選",
    viewGrid: "格狀檢視",
    viewList: "清單檢視",
    deleteChat: "刪除對話",
    deleteTitle: "刪除此對話？",
    deleteBody: "「{title}」及其所有訊息將被永久刪除。此操作無法復原。",
  },
  ...
  notebooks: {
    ...
    loadError: "無法載入此筆記本",
    loadErrorDesc: "載入此筆記本時發生錯誤。請檢查您的網路連線並重試。",
    updated: "已更新",
  ...
  sources: {
    ...
    parse: {
      reprocess: "重新處理",
      reprocessTitle: "重新處理此文件？",
      reprocessConfirm: "這將重新執行文件解析器並重建區塊版面——公式、圖與表格。現有的標註會自動重新錨定。可能需要幾分鐘。",
      reprocessQueued: "已開始重新處理",
      reprocessFailed: "無法開始重新處理",
      statusQueued: "排隊中",
      statusParsing: "解析中…",
      statusEmbedding: "產生向量中…",
      statusReady: "已解析",
      statusFailed: "解析失敗",
      statusNotParsed: "未解析",
      workingTip: "正在建立文件的區塊版面（公式、圖、結構）…",
      readyTip: "由 {parser} 解析 · 版本 {gen}",
      failedTip: "解析失敗。請嘗試重新處理。",
      notParsedTip: "此文件尚未解析為區塊。重新處理即可啟用基於結構的標註與閱讀器。",
      unknownParser: "未知解析器",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorStale: "已過期",
      anchorLegacy: "舊版",
      anchorAnchoredTip: "已錨定至此文件目前的解析版面配置。",
      anchorStaleTip: "建立醒目提示後此文件已重新解析，其錨點可能已過期。",
    ...
    rawContent: {
      open: "檢視原始內容",
      title: "原始內容",
      description: "此來源提供給 AI 聊天、搜尋與向量嵌入的擷取文字。",
    },
    reader: {
      tab: "閱讀檢視",
      pageNavLabel: "頁碼",
  ...
  chat: {
    ...
    annotationRefEmpty: "標註",
    annotationRefPage: "第 {page} 頁",
    annotationRefFigure: "圖",
    jumpToHighlight: "跳至標註",
    recallRelated: "與先前的學習相關",
    recallRefPage: "第 {page} 頁",
    recallOpenSession: "開啟該對話",
    recallJumpToHighlight: "跳至標註",
    recallKindExchange: "先前的討論",
    recallKindAnnotation: "你的標註",
    askAboutHighlight: "請跟我說說這段標註的內容。",
    askAboutTag: "幫我理解我標記為「{tag}」的標註內容。",
    tagAskTruncated: "僅傳送了標記為「{tag}」的前 10 個標註。",
    askDraft: {
      attached: "已附加 {count} 處標註",
      attachedQuote: "段落已加入提示詞",
      newChat: "新對話",
      newChatReady: "將傳送到新對話",
      dismiss: "移除附件",
    },
    ...
    uploadFailed: "附件上傳失敗",
    suggestedFollowups: "建議的後續問題",
    searchedYourSources: "已搜尋您的來源",
    readSources: "已讀取來源",
    readNote: "已讀取筆記",
    readNotebook: "已讀取筆記本",
    usedTool: "已使用工具",
    searchingYourSources: "正在搜尋您的來源…",
    readingSources: "正在讀取來源…",
    readingNote: "正在讀取筆記…",
    ...
    emptyTitle: "詢問關於此筆記本的問題",
    emptyHelper: "提出問題、總結來源，或在整個筆記本中探索想法。",
    suggestionSummarize: "總結我所有來源的重點",
    suggestionQuestions: "這些來源引出了哪些問題？",
    suggestionConnections: "找出我的筆記之間的關聯",
    meterSources: "{count} 個來源",
    meterNotes: "{count} 則筆記",
    meterTokens: "{count} 個權杖",
    contextMeterLabel: "上下文用量",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "已使用 {used} 個權杖",
    contextMeterEstimate: "上下文中約 {used} 個權杖",
    contextMeterTooltipExact: "模型回報的精確用量:{window} 個權杖中已使用 {used} 個({percent}%)。",
    contextMeterTooltipExactNoWindow: "模型回報的精確用量:{used} 個權杖。上下文視窗大小未知。",
    contextMeterTooltipEstimate: "根據所選上下文與此對話的訊息估算(每個權杖約 4 個字元)。模型未回報精確用量,因此不顯示百分比。",
    contextPreviewTitle: "上下文視窗中的內容",
    contextPreviewTotal: "~{tokens} 個權杖 · {chars} 個字元",
    contextPreviewSources: "來源 ({count})",
    contextPreviewNotes: "筆記 ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "洞見",
    contextPreviewModeFull: "全文",
    contextPreviewInsight: "洞見",
    contextPreviewUntitledSource: "無標題來源",
    contextPreviewUntitledNote: "無標題筆記",
    contextPreviewEmpty: "上下文視窗中沒有內容。將來源或筆記加入上下文以在此顯示。",
    contextPreviewBuilding: "正在產生上下文預覽…",
    contextPreviewApproxNote: "各項目的權杖數為估算值。",
    contextForThisChat: "此對話的內容範圍",
    resetToNotebookDefault: "重設為筆記本預設值",
    inheritingNotebookDefault: "繼承筆記本的預設內容範圍",
    contextIncludedCount: "已包含 {count} 項",
    sessions: "對話",
  ...
  jobs: {
    tray: {
      ...
      runningCount: "{count} 個進行中",
      failedCount: "{count} 個失敗",
      doneCount: "{count} 個完成",
      working: "進行中",
      finished: "最近完成",
      clearFinished: "清除已完成",
      lingerNote: "已完成的項目稍後會自動清除",
    },
    kind: {
      chat: "聊天",
      podcast: "正在產生Podcast",
  ...
  activity: {
    title: "活動",
    subtitle: "所有背景代理執行，最新的在前。選擇一個以重播其主控台。",
    empty: "尚無工作",
    emptyFiltered: "沒有符合此篩選條件的工作",
    undated: "無日期",
    jobCount: "{count} 個工作",
    refresh: "重新整理",
    filter: {
