export const esES = {
  ...
  gallery: {
    ...
    renameTag: "Cambiar nombre de etiqueta",
    groupByTag: "Agrupar por etiqueta",
    untagged: "Sin etiqueta",
    tagColor: "Color de etiqueta",
    searchPlaceholder: "Buscar chats…",
    noResults: "Ningún chat coincide con tu búsqueda.",
    editTags: "Editar etiquetas",
    tagInputPlaceholder: "Añadir una etiqueta…",
    clearFilters: "Borrar filtros",
    viewGrid: "Vista de cuadrícula",
    viewList: "Vista de lista",
    deleteChat: "Eliminar chat",
    deleteTitle: "¿Eliminar este chat?",
    deleteBody: "\"{title}\" y todos sus mensajes se eliminarán permanentemente. Esta acción no se puede deshacer.",
  },
  ...
  notebooks: {
    ...
    loadError: "No se pudo cargar este cuaderno",
    loadErrorDesc: "Algo salió mal al cargar este cuaderno. Comprueba tu conexión e inténtalo de nuevo.",
    updated: "Actualizado",
  ...
  sources: {
    ...
    parse: {
      ...
      reprocessTitle: "¿Reprocesar este documento?",
      reprocessConfirm: "Esto vuelve a ejecutar el analizador del documento y reconstruye el diseño de bloques: ecuaciones, figuras y tablas. Los resaltados existentes se vuelven a anclar automáticamente. Puede tardar unos minutos.",
      reprocessQueued: "Reprocesamiento iniciado",
      reprocessFailed: "No se pudo iniciar el reprocesamiento",
      statusQueued: "En cola",
      statusParsing: "Analizando…",
      statusEmbedding: "Generando embeddings…",
      statusReady: "Analizado",
      statusFailed: "Error de análisis",
      statusNotParsed: "Sin analizar",
      workingTip: "Creando el diseño de bloques del documento (ecuaciones, figuras, estructura)…",
      readyTip: "Analizado con {parser} · generación {gen}",
      failedTip: "El análisis falló. Prueba a reprocesar.",
      notParsedTip: "Este documento aún no se ha analizado en bloques. Reprocesa para habilitar resaltados según la estructura y el lector.",
      unknownParser: "analizador desconocido",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorAnchored: "Anclado",
      anchorStale: "Desactualizado",
      anchorLegacy: "Heredado",
      anchorAnchoredTip: "Anclado al diseño analizado actual de este documento.",
      anchorStaleTip: "Este documento se volvió a analizar después de crear el resaltado; su ancla puede estar desactualizada.",
    ...
    rawContent: {
      ...
      title: "Contenido sin formato",
      description: "El texto extraído que esta fuente aporta al chat con IA, la búsqueda y las incrustaciones.",
    },
    reader: {
      tab: "Lectura",
      pageNavLabel: "Número de página",
      ...
      typography: {
        ...
        headingSize: "Tamaño de los títulos",
  ...
  chat: {
    ...
    annotationRefEmpty: "Resaltado",
    annotationRefPage: "p. {page}",
    annotationRefFigure: "Figura",
    jumpToHighlight: "Ir al resaltado",
    recallRelated: "Relacionado con un estudio anterior",
    recallRefPage: "p. {page}",
    recallOpenSession: "Abrir ese chat",
    recallJumpToHighlight: "Ir al resaltado",
    recallKindExchange: "Discusión anterior",
    recallKindAnnotation: "Tu resaltado",
    ...
    askDraft: {
      attached: "{count} resaltado(s) adjunto(s)",
      attachedQuote: "Pasaje añadido a la petición",
      newChat: "Chat nuevo",
      newChatReady: "Se enviará a un chat nuevo",
      dismiss: "Quitar adjunto",
    },
    ...
    attachmentsCount: "{count} adjuntos",
    uploadFailed: "No se pudo subir el adjunto",
    suggestedFollowups: "Preguntas de seguimiento sugeridas",
    searchedYourSources: "Se buscaron tus fuentes",
    readSources: "Fuente leída",
    readNote: "Nota leída",
    readNotebook: "Cuaderno leído",
    usedTool: "Se usó una herramienta",
    searchingYourSources: "Buscando en tus fuentes…",
    readingSources: "Leyendo fuente…",
    readingNote: "Leyendo nota…",
    ...
    emptyHelper: "Haz preguntas, resume tus fuentes o explora ideas por todo el cuaderno.",
    suggestionSummarize: "Resume los puntos clave de mis fuentes",
    suggestionQuestions: "¿Qué preguntas plantean estas fuentes?",
    suggestionConnections: "Encuentra conexiones entre mis notas",
    meterSources: "{count} fuentes",
    meterNotes: "{count} notas",
    meterTokens: "{count} tokens",
    contextMeterLabel: "Uso del contexto",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} tokens usados",
    contextMeterEstimate: "~{used} tokens en contexto",
    contextMeterTooltipExact: "Uso exacto informado por el modelo: {used} de {window} tokens ({percent}%).",
    contextMeterTooltipExactNoWindow: "Uso exacto informado por el modelo: {used} tokens. Se desconoce el tamaño de su ventana de contexto.",
    contextMeterTooltipEstimate: "Estimado a partir del contexto seleccionado más los mensajes de este chat (~4 caracteres por token). El modelo no ha informado el uso exacto, por lo que no se muestra porcentaje.",
    contextPreviewTitle: "En la ventana de contexto",
    contextPreviewTotal: "~{tokens} tokens · {chars} caracteres",
    contextPreviewSources: "Fuentes ({count})",
    contextPreviewNotes: "Notas ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "Perspectivas",
    contextPreviewModeFull: "Completo",
    contextPreviewInsight: "Perspectiva",
    contextPreviewUntitledSource: "Fuente sin título",
    contextPreviewUntitledNote: "Nota sin título",
    contextPreviewEmpty: "No hay nada en la ventana de contexto. Activa fuentes o notas en el contexto para incluirlas aquí.",
    contextPreviewBuilding: "Generando vista previa del contexto…",
    contextPreviewApproxNote: "Los tamaños de token por elemento son aproximados.",
    contextForThisChat: "Contexto para este chat",
    resetToNotebookDefault: "Restablecer al valor predeterminado del cuaderno",
    inheritingNotebookDefault: "Heredando el contexto predeterminado del cuaderno",
    contextIncludedCount: "{count} incluidos",
    sessions: "Sesiones",
    ...
    modelGroupLocal: "Modelos locales y otros",
  ...
  jobs: {
    tray: {
      ...
      working: "En curso",
      finished: "Completados recientemente",
      clearFinished: "Borrar completados",
      lingerNote: "Los elementos completados desaparecen pronto",
    },
    kind: {
      chat: "Chat",
      podcast: "Generando podcast",
      source: "Leyendo fuente",
      embed: "Indexando para la búsqueda",
      chapters: "Construyendo capítulos",
      verify: "Revisando páginas",
      summarize: "Resumiendo capítulo",
    ...
    finishedToast: "{job} completado",
    failedToast: "{job} falló",
    view: "View",
  },
  console: {
    ...
    activity: "Actividad",
    context: "Contexto",
    goToOrigin: "Ir al origen",
    empty: "Aún no hay actividad",
    emptyContext: "No se capturó contexto para esta tarea",
    thinking: "Pensando",
    warning: "Advertencia",
    truncated: "Se recortaron eventos antiguos",
  ...
  activity: {
    title: "Actividad",
    subtitle: "Cada ejecución de agente en segundo plano, la más reciente primero. Selecciona una para reproducir su consola.",
    empty: "Aún no hay tareas",
    emptyFiltered: "Ninguna tarea coincide con este filtro",
    undated: "Sin fecha",
    jobCount: "{count} tareas",
    refresh: "Actualizar",
    filter: {
      all: "Todas",
      failed: "Fallidas",
