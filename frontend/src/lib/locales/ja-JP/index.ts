export const jaJP = {
  ...
  gallery: {
    ...
    noResults: "検索に一致するチャットはありません。",
    editTags: "タグを編集",
    tagInputPlaceholder: "タグを追加…",
    clearFilters: "フィルターをクリア",
    viewGrid: "グリッド表示",
    viewList: "リスト表示",
    deleteChat: "チャットを削除",
    deleteTitle: "このチャットを削除しますか？",
    deleteBody: "「{title}」とそのすべてのメッセージが完全に削除されます。この操作は元に戻せません。",
  },
  ...
  notebooks: {
    ...
    loadError: "このノートブックを読み込めませんでした",
    loadErrorDesc: "このノートブックの読み込み中に問題が発生しました。接続を確認して、もう一度お試しください。",
    updated: "更新日時",
  ...
  sources: {
    ...
    parse: {
      reprocess: "再処理",
      reprocessTitle: "このドキュメントを再処理しますか？",
      reprocessConfirm: "ドキュメントパーサーを再実行し、ブロックレイアウト（数式・図・表）を再構築します。既存のハイライトは自動的に再アンカーされます。数分かかる場合があります。",
      reprocessQueued: "再処理を開始しました",
      reprocessFailed: "再処理を開始できませんでした",
      statusQueued: "待機中",
      statusParsing: "解析中…",
      statusEmbedding: "埋め込み中…",
      statusReady: "解析済み",
      statusFailed: "解析に失敗",
      statusNotParsed: "未解析",
      workingTip: "ドキュメントのブロックレイアウト（数式・図・構造）を構築しています…",
      readyTip: "{parser} で解析済み · 世代 {gen}",
      failedTip: "解析に失敗しました。再処理をお試しください。",
      notParsedTip: "このドキュメントはまだブロックに解析されていません。再処理すると、構造を考慮したハイライトとリーダーが有効になります。",
      unknownParser: "不明なパーサー",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorStale: "古い",
      anchorLegacy: "旧式",
      anchorAnchoredTip: "この文書の現在の解析済みレイアウトに固定されています。",
      anchorStaleTip: "ハイライトの作成後に文書が再解析されました。アンカーが古い可能性があります。",
    ...
    rawContent: {
      open: "元のテキストを表示",
      title: "元のテキスト",
      description: "このソースが AI チャット・検索・埋め込みに提供する抽出テキストです。",
    },
    reader: {
      tab: "リーダー",
      pageNavLabel: "ページ番号",
      ...
      typography: {
        ...
        lineSpacing: "行間",
        reset: "リセット",
        decrease: "{label}を小さくする",
        increase: "{label}を大きくする",
      },
    },
  },
  chat: {
    referencedHighlights: "参照されたハイライト",
    annotationRefEmpty: "ハイライト",
    annotationRefPage: "p.{page}",
    annotationRefFigure: "図",
    jumpToHighlight: "ハイライトへ移動",
    recallRelated: "以前の学習に関連",
    recallRefPage: "p.{page}",
    recallOpenSession: "そのチャットを開く",
    recallJumpToHighlight: "ハイライトへ移動",
    recallKindExchange: "過去の議論",
    recallKindAnnotation: "あなたのハイライト",
    ...
    askDraft: {
      attached: "ハイライト {count} 件を添付",
      attachedQuote: "文章をプロンプトに追加しました",
      newChat: "新しいチャット",
      newChatReady: "新しいチャットに送信します",
      dismiss: "添付を削除",
    },
    ...
    attachmentsCount: "{count}件の添付",
    uploadFailed: "添付のアップロードに失敗しました",
    suggestedFollowups: "おすすめのフォローアップ",
    searchedYourSources: "ソースを検索しました",
    readSources: "ソースを読み込みました",
    readNote: "メモを読み込みました",
    readNotebook: "ノートブックを読み込みました",
    usedTool: "ツールを使用しました",
    searchingYourSources: "ソースを検索しています…",
    readingSources: "ソースを読み込んでいます…",
    readingNote: "メモを読み込んでいます…",
    ...
    emptyTitle: "このノートブックについて質問する",
    emptyHelper: "質問したり、ソースを要約したり、ノートブック全体のアイデアを探求できます。",
    suggestionSummarize: "ソース全体の要点を要約する",
    suggestionQuestions: "これらのソースが提起する疑問は？",
    suggestionConnections: "メモ間のつながりを見つける",
    meterSources: "ソース {count} 件",
    meterNotes: "メモ {count} 件",
    meterTokens: "{count} トークン",
    contextMeterLabel: "コンテキスト使用量",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} トークン使用",
    contextMeterEstimate: "~{used} トークンがコンテキスト内",
    contextMeterTooltipExact: "モデルが報告した正確な使用量: {window} トークン中 {used} トークン({percent}%)。",
    contextMeterTooltipExactNoWindow: "モデルが報告した正確な使用量: {used} トークン。コンテキストウィンドウのサイズは不明です。",
    contextMeterTooltipEstimate: "選択したコンテキストとこのチャットのメッセージから推定(1トークンあたり約4文字)。モデルが正確な使用量を報告していないため、割合は表示されません。",
    contextPreviewTitle: "コンテキストウィンドウの内容",
    contextPreviewTotal: "~{tokens} トークン · {chars} 文字",
    contextPreviewSources: "ソース ({count})",
    contextPreviewNotes: "メモ ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "インサイト",
    contextPreviewModeFull: "全文",
    contextPreviewInsight: "インサイト",
    contextPreviewUntitledSource: "無題のソース",
    contextPreviewUntitledNote: "無題のメモ",
    contextPreviewEmpty: "コンテキストウィンドウには何も含まれていません。ソースやメモをコンテキストに追加するとここに表示されます。",
    contextPreviewBuilding: "コンテキストのプレビューを作成中…",
    contextPreviewApproxNote: "各項目のトークン数は概算です。",
    contextForThisChat: "このチャットのコンテキスト",
    resetToNotebookDefault: "ノートブックの既定値にリセット",
    inheritingNotebookDefault: "ノートブックの既定のコンテキストを継承しています",
    contextIncludedCount: "{count}件を含む",
    sessions: "セッション",
  ...
  jobs: {
    ...
    finishedToast: "{job} が完了しました",
    failedToast: "{job} が失敗しました",
    view: "View",
  },
  console: {
    title: "エージェントコンソール",
    ...
    emptyContext: "このジョブのコンテキストは取得されていません",
    thinking: "思考中",
    warning: "警告",
    truncated: "古いイベントは削除されました",
    chars: "{count} 文字",
  ...
  activity: {
    title: "アクティビティ",
    subtitle: "すべてのバックグラウンドエージェントの実行を新しい順に表示します。1つ選択するとコンソールを再生できます。",
    empty: "まだジョブはありません",
    emptyFiltered: "このフィルターに一致するジョブはありません",
    undated: "日付なし",
