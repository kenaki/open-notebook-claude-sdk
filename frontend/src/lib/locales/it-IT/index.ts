export const itIT = {
  ...
  gallery: {
    ...
    groupByTag: "Raggruppa per tag",
    untagged: "Senza tag",
    tagColor: "Colore del tag",
    searchPlaceholder: "Cerca chat…",
    noResults: "Nessuna chat corrisponde alla ricerca.",
    editTags: "Modifica tag",
    tagInputPlaceholder: "Aggiungi un tag…",
    clearFilters: "Cancella filtri",
    viewGrid: "Vista griglia",
    viewList: "Vista elenco",
    deleteChat: "Elimina chat",
    deleteTitle: "Eliminare questa chat?",
    deleteBody: "\"{title}\" e tutti i suoi messaggi verranno eliminati definitivamente. Questa azione non può essere annullata.",
  },
  ...
  notebooks: {
    ...
    loadError: "Impossibile caricare questo quaderno",
    loadErrorDesc: "Si è verificato un problema durante il caricamento di questo quaderno. Controlla la connessione e riprova.",
    updated: "Aggiornato",
  ...
  sources: {
    ...
    parse: {
      reprocess: "Rielabora",
      reprocessTitle: "Rielaborare questo documento?",
      reprocessConfirm: "Questo riesegue il parser del documento e ricostruisce il layout a blocchi: equazioni, figure e tabelle. Le evidenziazioni esistenti vengono riancorate automaticamente. Può richiedere alcuni minuti.",
      reprocessQueued: "Rielaborazione avviata",
      reprocessFailed: "Impossibile avviare la rielaborazione",
      statusQueued: "In coda",
      statusParsing: "Analisi in corso…",
      statusEmbedding: "Creazione embedding…",
      statusReady: "Analizzato",
      statusFailed: "Analisi non riuscita",
      statusNotParsed: "Non analizzato",
      workingTip: "Creazione del layout a blocchi del documento (equazioni, figure, struttura)…",
      readyTip: "Analizzato con {parser} · generazione {gen}",
      failedTip: "Analisi non riuscita. Prova a rielaborare.",
      notParsedTip: "Questo documento non è ancora stato analizzato in blocchi. Rielabora per abilitare evidenziazioni basate sulla struttura e il lettore.",
      unknownParser: "parser sconosciuto",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorAnchored: "Ancorato",
      anchorStale: "Obsoleto",
      anchorLegacy: "Legacy",
      anchorAnchoredTip: "Ancorato al layout analizzato corrente di questo documento.",
      anchorStaleTip: "Questo documento è stato rianalizzato dopo la creazione dell'evidenziazione; l'ancoraggio potrebbe non essere aggiornato.",
    ...
    rawContent: {
      ...
      title: "Contenuto grezzo",
      description: "Il testo estratto che questa fonte fornisce a chat IA, ricerca ed embedding.",
    },
    reader: {
      tab: "Lettura",
      pageNavLabel: "Numero di pagina",
      pageOfCount: "di {count}",
      notReady: "Questo documento non è ancora stato analizzato.",
      outline: "Struttura",
  ...
  chat: {
    referencedHighlights: "Evidenziazioni referenziate",
    annotationRefEmpty: "Evidenziazione",
    annotationRefPage: "p. {page}",
    annotationRefFigure: "Figura",
    jumpToHighlight: "Vai all'evidenziazione",
    recallRelated: "Collegato a uno studio precedente",
    recallRefPage: "p. {page}",
    recallOpenSession: "Apri quella chat",
    recallJumpToHighlight: "Vai all'evidenziazione",
    recallKindExchange: "Discussione precedente",
    recallKindAnnotation: "La tua evidenziazione",
    ...
    askDraft: {
      attached: "{count} evidenziazione/i allegata/e",
      attachedQuote: "Passaggio aggiunto al prompt",
      newChat: "Nuova chat",
      newChatReady: "Invio a una nuova chat",
      dismiss: "Rimuovi allegato",
    },
    ...
    explain: "Explain",
    saveNote: "Save note",
    discussingPassage: "Stai discutendo questo passaggio",
    ...
    suggestedFollowups: "Domande di approfondimento suggerite",
    searchedYourSources: "Ricerca nelle tue fonti",
    readSources: "Fonte letta",
    readNote: "Nota letta",
    readNotebook: "Blocco note letto",
    usedTool: "Strumento utilizzato",
    searchingYourSources: "Ricerca in corso nelle tue fonti…",
    readingSources: "Lettura della fonte…",
    ...
    emptyTitle: "Chiedi su questo notebook",
    emptyHelper: "Fai domande, riassumi le tue fonti o esplora idee in tutto il notebook.",
    suggestionSummarize: "Riassumi i punti chiave delle mie fonti",
    suggestionQuestions: "Quali domande sollevano queste fonti?",
    suggestionConnections: "Trova collegamenti tra le mie note",
    meterSources: "{count} fonti",
    meterNotes: "{count} note",
    meterTokens: "{count} token",
    contextMeterLabel: "Utilizzo del contesto",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} token utilizzati",
    contextMeterEstimate: "~{used} token nel contesto",
    contextMeterTooltipExact: "Utilizzo esatto riportato dal modello: {used} di {window} token ({percent}%).",
    contextMeterTooltipExactNoWindow: "Utilizzo esatto riportato dal modello: {used} token. La dimensione della sua finestra di contesto è sconosciuta.",
    contextMeterTooltipEstimate: "Stima basata sul contesto selezionato più i messaggi di questa chat (~4 caratteri per token). Il modello non ha riportato l'utilizzo esatto, quindi non viene mostrata alcuna percentuale.",
    contextPreviewTitle: "Nella finestra di contesto",
    contextPreviewTotal: "~{tokens} token · {chars} caratteri",
    contextPreviewSources: "Fonti ({count})",
    contextPreviewNotes: "Note ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "Approfondimenti",
    contextPreviewModeFull: "Completo",
    contextPreviewInsight: "Approfondimento",
    contextPreviewUntitledSource: "Fonte senza titolo",
    contextPreviewUntitledNote: "Nota senza titolo",
    contextPreviewEmpty: "Non c'è nulla nella finestra di contesto. Attiva fonti o note nel contesto per includerle qui.",
    contextPreviewBuilding: "Creazione anteprima del contesto…",
    contextPreviewApproxNote: "Le dimensioni dei token per elemento sono approssimative.",
    contextForThisChat: "Contesto per questa chat",
    resetToNotebookDefault: "Ripristina il valore predefinito del notebook",
    inheritingNotebookDefault: "Eredita il contesto predefinito del notebook",
    contextIncludedCount: "{count} inclusi",
    sessions: "Sessioni",
    ...
    modelGroupLocal: "Modelli locali e altri",
  ...
  jobs: {
    tray: {
      ...
      idle: "Tutto aggiornato",
      activeCount: "{count} background jobs",
      runningCount: "{count} in corso",
      failedCount: "{count} non riusciti",
      doneCount: "{count} completati",
      working: "In corso",
      finished: "Completati di recente",
      clearFinished: "Cancella completati",
      lingerNote: "Gli elementi completati spariscono a breve",
    },
    kind: {
      chat: "Chat",
      podcast: "Generazione podcast",
      source: "Lettura della fonte",
      embed: "Indicizzazione per la ricerca",
      chapters: "Creazione capitoli",
      verify: "Revisione pagine",
      summarize: "Riepilogo capitolo",
    ...
    finishedToast: "{job} completato",
    failedToast: "{job} non riuscito",
    view: "View",
  },
  console: {
    title: "Console dell'agente",
    activity: "Attività",
    context: "Contesto",
    goToOrigin: "Vai all'origine",
    empty: "Ancora nessuna attività",
    emptyContext: "Nessun contesto acquisito per questo lavoro",
    thinking: "Sta pensando",
    warning: "Avviso",
    truncated: "Gli eventi meno recenti sono stati rimossi",
  ...
  activity: {
    title: "Attività",
    subtitle: "Ogni esecuzione dell'agente in background, la più recente per prima. Selezionane una per riprodurne la console.",
    empty: "Ancora nessun lavoro",
    emptyFiltered: "Nessun lavoro corrisponde a questo filtro",
    undated: "Senza data",
    jobCount: "{count} lavori",
    refresh: "Aggiorna",
    filter: {
      all: "Tutti",
      failed: "Falliti",
