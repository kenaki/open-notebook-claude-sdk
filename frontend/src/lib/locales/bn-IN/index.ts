export const bnIN = {
  ...
  gallery: {
    ...
    renameTag: "ট্যাগের নাম পরিবর্তন করুন",
    groupByTag: "ট্যাগ অনুসারে গ্রুপ করুন",
    untagged: "ট্যাগবিহীন",
    tagColor: "ট্যাগের রঙ",
    searchPlaceholder: "চ্যাট খুঁজুন…",
    noResults: "আপনার অনুসন্ধানের সাথে কোনো চ্যাট মেলেনি।",
    editTags: "ট্যাগ সম্পাদনা করুন",
    tagInputPlaceholder: "একটি ট্যাগ যোগ করুন…",
    clearFilters: "ফিল্টার সাফ করুন",
    viewGrid: "গ্রিড ভিউ",
    viewList: "তালিকা ভিউ",
    deleteChat: "চ্যাট মুছুন",
    deleteTitle: "এই চ্যাটটি মুছবেন?",
    deleteBody: "\"{title}\" এবং এর সমস্ত বার্তা স্থায়ীভাবে মুছে ফেলা হবে। এই ক্রিয়াটি পূর্বাবস্থায় ফেরানো যাবে না।",
  },
  ...
  notebooks: {
    ...
    loadError: "এই নোটবুকটি লোড করা যায়নি",
    loadErrorDesc: "এই নোটবুক লোড করার সময় কিছু ভুল হয়েছে। আপনার সংযোগ পরীক্ষা করে আবার চেষ্টা করুন।",
    updated: "আপডেট করা",
  ...
  sources: {
    ...
    parse: {
      reprocess: "পুনরায় প্রক্রিয়া করুন",
      reprocessTitle: "এই নথিটি পুনরায় প্রক্রিয়া করবেন?",
      reprocessConfirm: "এটি নথির পার্সার পুনরায় চালায় এবং ব্লক লেআউট—সমীকরণ, চিত্র ও টেবিল—পুনর্নির্মাণ করে। বিদ্যমান হাইলাইটগুলি স্বয়ংক্রিয়ভাবে পুনরায় অ্যাঙ্কর হয়। এতে কয়েক মিনিট লাগতে পারে।",
      reprocessQueued: "পুনঃপ্রক্রিয়া শুরু হয়েছে",
      reprocessFailed: "পুনঃপ্রক্রিয়া শুরু করা যায়নি",
      statusQueued: "সারিতে",
      statusParsing: "পার্স করা হচ্ছে…",
      statusEmbedding: "এমবেডিং করা হচ্ছে…",
      statusReady: "পার্স করা হয়েছে",
      statusFailed: "পার্স ব্যর্থ",
      statusNotParsed: "পার্স করা হয়নি",
      workingTip: "নথির ব্লক লেআউট (সমীকরণ, চিত্র, কাঠামো) তৈরি করা হচ্ছে…",
      readyTip: "{parser} দিয়ে পার্স করা হয়েছে · প্রজন্ম {gen}",
      failedTip: "পার্স ব্যর্থ হয়েছে। পুনরায় প্রক্রিয়া করে দেখুন।",
      notParsedTip: "এই নথিটি এখনও ব্লকে পার্স করা হয়নি। কাঠামো-সচেতন হাইলাইট ও রিডার সক্রিয় করতে পুনরায় প্রক্রিয়া করুন।",
      unknownParser: "অজানা পার্সার",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorAnchored: "অ্যাঙ্করড",
      anchorStale: "পুরনো",
      anchorLegacy: "লিগ্যাসি",
      anchorAnchoredTip: "এই নথির বর্তমান পার্স করা লেআউটে অ্যাঙ্কর করা হয়েছে।",
      anchorStaleTip: "হাইলাইট তৈরির পরে এই নথিটি পুনরায় পার্স করা হয়েছে; এর অ্যাঙ্কর পুরনো হতে পারে।",
    ...
    rawContent: {
      ...
      title: "কাঁচা বিষয়বস্তু",
      description: "এই উৎস এআই চ্যাট, অনুসন্ধান এবং এমবেডিংয়ে যে নিষ্কাশিত পাঠ্য সরবরাহ করে।",
    },
    reader: {
      tab: "পাঠক",
      pageNavLabel: "পৃষ্ঠা নম্বর",
      pageOfCount: "{count} এর মধ্যে",
      notReady: "এই নথিটি এখনও পার্স করা হয়নি।",
      outline: "রূপরেখা",
      untitledSection: "শিরোনামহীন বিভাগ",
      page: "পৃ. {page}",
      expandSection: "বিভাগ প্রসারিত করুন",
      collapseSection: "বিভাগ সংকুচিত করুন",
      figureAlt: "চিত্র",
      ...
      typography: {
        ...
        headingSize: "শিরোনামের আকার",
        lineSpacing: "লাইনের ব্যবধান",
        reset: "রিসেট",
        decrease: "{label} কমান",
        increase: "{label} বাড়ান",
      },
    },
  },
  chat: {
    referencedHighlights: "উল্লেখিত হাইলাইট",
    annotationRefEmpty: "হাইলাইট",
    annotationRefPage: "পৃ. {page}",
    annotationRefFigure: "চিত্র",
    jumpToHighlight: "হাইলাইটে যান",
    recallRelated: "আগের পড়াশোনার সাথে সম্পর্কিত",
    recallRefPage: "পৃ. {page}",
    recallOpenSession: "সেই চ্যাটটি খুলুন",
    recallJumpToHighlight: "হাইলাইটে যান",
    recallKindExchange: "পূর্ববর্তী আলোচনা",
    recallKindAnnotation: "আপনার হাইলাইট",
    ...
    askDraft: {
      attached: "{count}টি হাইলাইট যুক্ত",
      attachedQuote: "অনুচ্ছেদ প্রম্পটে যোগ করা হয়েছে",
      newChat: "নতুন চ্যাট",
      newChatReady: "নতুন চ্যাটে পাঠানো হবে",
      dismiss: "সংযুক্তি সরান",
    },
    ...
    uploadFailed: "সংযুক্তি আপলোড করা যায়নি",
    suggestedFollowups: "প্রস্তাবিত ফলো-আপ",
    searchedYourSources: "আপনার উৎস অনুসন্ধান করা হয়েছে",
    readSources: "উৎস পড়া হয়েছে",
    readNote: "নোট পড়া হয়েছে",
    readNotebook: "নোটবুক পড়া হয়েছে",
    usedTool: "একটি টুল ব্যবহার করা হয়েছে",
    searchingYourSources: "আপনার উৎস অনুসন্ধান করা হচ্ছে…",
    readingSources: "উৎস পড়া হচ্ছে…",
    readingNote: "নোট পড়া হচ্ছে…",
    ...
    emptyTitle: "এই নোটবুক সম্পর্কে জিজ্ঞাসা করুন",
    emptyHelper: "প্রশ্ন করুন, আপনার উৎসগুলি সংক্ষিপ্ত করুন, বা নোটবুক জুড়ে ধারণা অন্বেষণ করুন।",
    suggestionSummarize: "আমার উৎসগুলির মূল বিষয়গুলি সংক্ষিপ্ত করুন",
    suggestionQuestions: "এই উৎসগুলি কী প্রশ্ন উত্থাপন করে?",
    suggestionConnections: "আমার নোটগুলির মধ্যে সংযোগ খুঁজুন",
    meterSources: "{count} উৎস",
    meterNotes: "{count} নোট",
    meterTokens: "{count} টোকেন",
    contextMeterLabel: "কনটেক্সট ব্যবহার",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} টোকেন ব্যবহৃত",
    contextMeterEstimate: "~{used} টোকেন কনটেক্সটে",
    contextMeterTooltipExact: "মডেল দ্বারা জানানো সঠিক ব্যবহার: {window} টোকেনের মধ্যে {used} ({percent}%)।",
    contextMeterTooltipExactNoWindow: "মডেল দ্বারা জানানো সঠিক ব্যবহার: {used} টোকেন। কনটেক্সট উইন্ডোর আকার অজানা।",
    contextMeterTooltipEstimate: "নির্বাচিত কনটেক্সট ও এই চ্যাটের বার্তা থেকে আনুমানিক (প্রতি টোকেনে ~৪ অক্ষর)। মডেল সঠিক ব্যবহার জানায়নি, তাই কোনো শতাংশ দেখানো হয় না।",
    contextPreviewTitle: "কনটেক্সট উইন্ডোতে যা আছে",
    contextPreviewTotal: "~{tokens} টোকেন · {chars} অক্ষর",
    contextPreviewSources: "উৎস ({count})",
    contextPreviewNotes: "নোট ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "অন্তর্দৃষ্টি",
    contextPreviewModeFull: "সম্পূর্ণ",
    contextPreviewInsight: "অন্তর্দৃষ্টি",
    contextPreviewUntitledSource: "শিরোনামহীন উৎস",
    contextPreviewUntitledNote: "শিরোনামহীন নোট",
    contextPreviewEmpty: "কনটেক্সট উইন্ডোতে কিছু নেই। এখানে অন্তর্ভুক্ত করতে উৎস বা নোট কনটেক্সটে যোগ করুন।",
    contextPreviewBuilding: "কনটেক্সট প্রিভিউ তৈরি হচ্ছে…",
    contextPreviewApproxNote: "প্রতিটি আইটেমের টোকেন আকার আনুমানিক।",
    contextForThisChat: "এই চ্যাটের প্রসঙ্গ",
    resetToNotebookDefault: "নোটবুকের ডিফল্টে রিসেট করুন",
    inheritingNotebookDefault: "নোটবুকের ডিফল্ট প্রসঙ্গ অনুসরণ করছে",
    contextIncludedCount: "{count}টি অন্তর্ভুক্ত",
    sessions: "সেশনগুলি",
    ...
    modelGroupLocal: "লোকাল ও অন্যান্য মডেল",
  ...
  jobs: {
    tray: {
      ...
      runningCount: "{count}টি চলছে",
      failedCount: "{count}টি ব্যর্থ",
      doneCount: "{count}টি সম্পন্ন",
      working: "চলছে",
      finished: "সম্প্রতি সম্পন্ন",
      clearFinished: "সম্পন্নগুলো মুছুন",
      lingerNote: "সম্পন্ন আইটেমগুলো শীঘ্রই মুছে যাবে",
    },
    kind: {
      chat: "চ্যাট",
      podcast: "পডকাস্ট তৈরি হচ্ছে",
      source: "উৎস পড়া হচ্ছে",
      embed: "অনুসন্ধানের জন্য ইনডেক্স করা হচ্ছে",
      chapters: "অধ্যায় তৈরি হচ্ছে",
      verify: "পৃষ্ঠা প্রুফ করা হচ্ছে",
      summarize: "অধ্যায় সংক্ষিপ্ত করা হচ্ছে",
    ...
    finishedToast: "{job} সম্পন্ন হয়েছে",
    failedToast: "{job} ব্যর্থ হয়েছে",
    view: "View",
  },
  console: {
    title: "এজেন্ট কনসোল",
    activity: "কার্যকলাপ",
    context: "প্রসঙ্গ",
    goToOrigin: "মূল স্থানে যান",
    empty: "এখনও কোনো কার্যকলাপ নেই",
    emptyContext: "এই কাজের জন্য কোনো প্রসঙ্গ ধরা পড়েনি",
    thinking: "ভাবছে",
    warning: "সতর্কতা",
    truncated: "পুরনো ইভেন্টগুলো ছেঁটে ফেলা হয়েছে",
  ...
  activity: {
    title: "কার্যকলাপ",
    subtitle: "প্রতিটি ব্যাকগ্রাউন্ড এজেন্ট রান, নতুনতমটি প্রথমে। কনসোল পুনরায় দেখতে একটি নির্বাচন করুন।",
    empty: "এখনও কোনো কাজ নেই",
    emptyFiltered: "এই ফিল্টারের সাথে কোনো কাজ মেলে না",
    undated: "তারিখবিহীন",
    jobCount: "{count}টি কাজ",
    refresh: "রিফ্রেশ",
    filter: {
      all: "সব",
      failed: "ব্যর্থ",
