export const frFR = {
  ...
  gallery: {
    ...
    groupByTag: "Grouper par tag",
    untagged: "Sans tag",
    tagColor: "Couleur du tag",
    searchPlaceholder: "Rechercher des chats…",
    noResults: "Aucun chat ne correspond à votre recherche.",
    editTags: "Modifier les tags",
    tagInputPlaceholder: "Ajouter un tag…",
    clearFilters: "Effacer les filtres",
    viewGrid: "Vue grille",
    viewList: "Vue liste",
    deleteChat: "Supprimer le chat",
    deleteTitle: "Supprimer ce chat ?",
    deleteBody: "« {title} » et tous ses messages seront définitivement supprimés. Cette action est irréversible.",
  },
  ...
  notebooks: {
    ...
    loadError: "Impossible de charger ce carnet",
    loadErrorDesc: "Une erreur s'est produite lors du chargement de ce carnet. Vérifiez votre connexion et réessayez.",
    updated: "Mis à jour",
  ...
  sources: {
    ...
    parse: {
      reprocess: "Retraiter",
      reprocessTitle: "Retraiter ce document ?",
      reprocessConfirm: "Cela relance l'analyseur du document et reconstruit la structure en blocs : équations, figures et tableaux. Les surlignages existants sont ré-ancrés automatiquement. Cela peut prendre quelques minutes.",
      reprocessQueued: "Retraitement lancé",
      reprocessFailed: "Impossible de lancer le retraitement",
      statusQueued: "En file d'attente",
      statusParsing: "Analyse…",
      statusEmbedding: "Vectorisation…",
      statusReady: "Analysé",
      statusFailed: "Échec de l'analyse",
      statusNotParsed: "Non analysé",
      workingTip: "Construction de la structure en blocs du document (équations, figures, structure)…",
      readyTip: "Analysé avec {parser} · génération {gen}",
      failedTip: "L'analyse a échoué. Essayez de retraiter.",
      notParsedTip: "Ce document n'a pas encore été analysé en blocs. Retraitez-le pour activer les surlignages basés sur la structure et le lecteur.",
      unknownParser: "analyseur inconnu",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorAnchored: "Ancré",
      anchorStale: "Obsolète",
      anchorLegacy: "Ancien",
      anchorAnchoredTip: "Ancré à la mise en page analysée actuelle de ce document.",
      anchorStaleTip: "Ce document a été réanalysé après la création du surlignage ; son ancrage peut être obsolète.",
    ...
    rawContent: {
      ...
      title: "Contenu brut",
      description: "Le texte extrait que cette source fournit au chat IA, à la recherche et aux embeddings.",
    },
    reader: {
      tab: "Lecture",
      pageNavLabel: "Numéro de page",
      pageOfCount: "sur {count}",
  ...
  chat: {
    ...
    annotationRefEmpty: "Surlignage",
    annotationRefPage: "p. {page}",
    annotationRefFigure: "Figure",
    jumpToHighlight: "Aller au surlignage",
    recallRelated: "Lié à une étude antérieure",
    recallRefPage: "p. {page}",
    recallOpenSession: "Ouvrir cette discussion",
    recallJumpToHighlight: "Aller au surlignage",
    recallKindExchange: "Discussion précédente",
    recallKindAnnotation: "Votre surlignage",
    ...
    askDraft: {
      attached: "{count} surlignage(s) joint(s)",
      attachedQuote: "Passage ajouté à la requête",
      newChat: "Nouveau chat",
      newChatReady: "Envoi vers un nouveau chat",
      dismiss: "Retirer la pièce jointe",
    },
    ...
    explain: "Explain",
    saveNote: "Save note",
    discussingPassage: "À propos de ce passage",
    attachImage: "Joindre une image",
    attachVideo: "Joindre une vidéo",
    removeAttachment: "Supprimer la pièce jointe",
    attachmentsCount: "{count} pièces jointes",
    uploadFailed: "Échec du téléversement de la pièce jointe",
    suggestedFollowups: "Questions de suivi suggérées",
    searchedYourSources: "Recherche dans vos sources",
    readSources: "Source lue",
    readNote: "Note lue",
    readNotebook: "Carnet lu",
    usedTool: "Outil utilisé",
    searchingYourSources: "Recherche en cours dans vos sources…",
    readingSources: "Lecture de la source…",
    ...
    emptyTitle: "Posez une question sur ce carnet",
    emptyHelper: "Posez des questions, résumez vos sources ou explorez des idées dans tout le carnet.",
    suggestionSummarize: "Résumez les points clés de mes sources",
    suggestionQuestions: "Quelles questions ces sources soulèvent-elles ?",
    suggestionConnections: "Trouvez des liens entre mes notes",
    meterSources: "{count} sources",
    meterNotes: "{count} notes",
    meterTokens: "{count} jetons",
    contextMeterLabel: "Utilisation du contexte",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} jetons utilisés",
    contextMeterEstimate: "~{used} jetons dans le contexte",
    contextMeterTooltipExact: "Utilisation exacte rapportée par le modèle : {used} sur {window} jetons ({percent}%).",
    contextMeterTooltipExactNoWindow: "Utilisation exacte rapportée par le modèle : {used} jetons. La taille de sa fenêtre de contexte est inconnue.",
    contextMeterTooltipEstimate: "Estimation basée sur le contexte sélectionné et les messages de cette discussion (~4 caractères par jeton). Le modèle n'a pas rapporté d'utilisation exacte, donc aucun pourcentage n'est affiché.",
    contextPreviewTitle: "Dans la fenêtre de contexte",
    contextPreviewTotal: "~{tokens} jetons · {chars} caractères",
    contextPreviewSources: "Sources ({count})",
    contextPreviewNotes: "Notes ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "Analyses",
    contextPreviewModeFull: "Complet",
    contextPreviewInsight: "Analyse",
    contextPreviewUntitledSource: "Source sans titre",
    contextPreviewUntitledNote: "Note sans titre",
    contextPreviewEmpty: "La fenêtre de contexte est vide. Ajoutez des sources ou des notes au contexte pour les afficher ici.",
    contextPreviewBuilding: "Génération de l'aperçu du contexte…",
    contextPreviewApproxNote: "Les tailles de jetons par élément sont approximatives.",
    contextForThisChat: "Contexte pour cette discussion",
    resetToNotebookDefault: "Réinitialiser au contexte par défaut du notebook",
    inheritingNotebookDefault: "Hérite du contexte par défaut du notebook",
    contextIncludedCount: "{count} inclus",
    sessions: "Sessions",
    ...
    modelGroupLocal: "Modèles locaux et autres",
  ...
  jobs: {
    tray: {
      ...
      doneCount: "{count} terminé(s)",
      working: "En cours",
      finished: "Récemment terminés",
      clearFinished: "Effacer les terminés",
      lingerNote: "Les éléments terminés disparaissent sous peu",
    },
    kind: {
      chat: "Discussion",
      podcast: "Génération du podcast",
      source: "Lecture de la source",
      embed: "Indexation pour la recherche",
      chapters: "Construction des chapitres",
      verify: "Relecture des pages",
      summarize: "Résumé du chapitre",
    ...
    finishedToast: "{job} terminé",
    failedToast: "{job} a échoué",
    view: "View",
  },
  console: {
    title: "Console de l'agent",
    activity: "Activité",
    context: "Contexte",
    goToOrigin: "Aller à l'origine",
    empty: "Aucune activité pour le moment",
    emptyContext: "Aucun contexte capturé pour cette tâche",
    thinking: "Réflexion en cours",
    warning: "Avertissement",
    truncated: "Les événements les plus anciens ont été supprimés",
    chars: "{count} caractères",
    contextArgs: "Contexte envoyé",
    contextMessage: "Message envoyé",
    streaming: "En cours…",
    jobFailed: "Cette tâche a échoué",
  },
  activity: {
    title: "Activité",
    subtitle: "Chaque exécution d'agent en arrière-plan, la plus récente en premier. Sélectionnez-en une pour rejouer sa console.",
