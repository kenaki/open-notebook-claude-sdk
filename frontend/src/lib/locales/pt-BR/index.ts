export const ptBR = {
  ...
  gallery: {
    ...
    noResults: "Nenhum chat corresponde à sua pesquisa.",
    editTags: "Editar tags",
    tagInputPlaceholder: "Adicionar uma tag…",
    clearFilters: "Limpar filtros",
    viewGrid: "Visualização em grade",
    viewList: "Visualização em lista",
    deleteChat: "Excluir chat",
    deleteTitle: "Excluir este chat?",
    deleteBody: "\"{title}\" e todas as suas mensagens serão excluídos permanentemente. Esta ação não pode ser desfeita.",
  },
  ...
  notebooks: {
    ...
    loadError: "Não foi possível carregar este caderno",
    loadErrorDesc: "Algo deu errado ao carregar este caderno. Verifique sua conexão e tente novamente.",
    updated: "Atualizado",
  ...
  sources: {
    ...
    parse: {
      ...
      reprocessTitle: "Reprocessar este documento?",
      reprocessConfirm: "Isto executa novamente o analisador do documento e reconstrói o layout de blocos: equações, figuras e tabelas. Os destaques existentes são reancorados automaticamente. Pode levar alguns minutos.",
      reprocessQueued: "Reprocessamento iniciado",
      reprocessFailed: "Falha ao iniciar o reprocessamento",
      statusQueued: "Na fila",
      statusParsing: "Analisando…",
      statusEmbedding: "Gerando embeddings…",
      statusReady: "Analisado",
      statusFailed: "Falha na análise",
      statusNotParsed: "Não analisado",
      workingTip: "Criando o layout de blocos do documento (equações, figuras, estrutura)…",
      readyTip: "Analisado com {parser} · geração {gen}",
      failedTip: "A análise falhou. Tente reprocessar.",
      notParsedTip: "Este documento ainda não foi analisado em blocos. Reprocesse para habilitar destaques com base na estrutura e o leitor.",
      unknownParser: "analisador desconhecido",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorAnchored: "Ancorado",
      anchorStale: "Desatualizado",
      anchorLegacy: "Legado",
      anchorAnchoredTip: "Ancorado ao layout analisado atual deste documento.",
      anchorStaleTip: "Este documento foi reanalisado após a criação do destaque; sua âncora pode estar desatualizada.",
    ...
    rawContent: {
      ...
      description: "O texto extraído que esta fonte fornece ao chat de IA, à busca e aos embeddings.",
    },
    reader: {
      tab: "Leitura",
      pageNavLabel: "Número da página",
  ...
  chat: {
    ...
    annotationRefEmpty: "Destaque",
    annotationRefPage: "p. {page}",
    annotationRefFigure: "Figura",
    jumpToHighlight: "Ir para o destaque",
    recallRelated: "Relacionado a um estudo anterior",
    recallRefPage: "p. {page}",
    recallOpenSession: "Abrir aquele chat",
    recallJumpToHighlight: "Ir para o destaque",
    recallKindExchange: "Discussão anterior",
    recallKindAnnotation: "Seu destaque",
    ...
    askDraft: {
      attached: "{count} destaque(s) anexado(s)",
      attachedQuote: "Trecho adicionado ao prompt",
      newChat: "Novo chat",
      newChatReady: "Enviando para um novo chat",
      dismiss: "Remover anexo",
    },
    ...
    explain: "Explain",
    saveNote: "Save note",
    discussingPassage: "Discutindo este trecho",
    attachImage: "Anexar imagem",
    attachVideo: "Anexar vídeo",
    removeAttachment: "Remover anexo",
    attachmentsCount: "{count} anexos",
    uploadFailed: "Falha ao enviar o anexo",
    suggestedFollowups: "Perguntas de acompanhamento sugeridas",
    searchedYourSources: "Pesquisou suas fontes",
    readSources: "Fonte lida",
    readNote: "Nota lida",
    readNotebook: "Caderno lido",
    usedTool: "Usou uma ferramenta",
    searchingYourSources: "Pesquisando suas fontes…",
    readingSources: "Lendo fonte…",
    readingNote: "Lendo nota…",
    ...
    emptyTitle: "Pergunte sobre este notebook",
    emptyHelper: "Faça perguntas, resuma suas fontes ou explore ideias por todo o notebook.",
    suggestionSummarize: "Resuma os pontos principais das minhas fontes",
    suggestionQuestions: "Que perguntas essas fontes levantam?",
    suggestionConnections: "Encontre conexões entre minhas notas",
    meterSources: "{count} fontes",
    meterNotes: "{count} notas",
    meterTokens: "{count} tokens",
    contextMeterLabel: "Uso do contexto",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} tokens usados",
    contextMeterEstimate: "~{used} tokens no contexto",
    contextMeterTooltipExact: "Uso exato informado pelo modelo: {used} de {window} tokens ({percent}%).",
    contextMeterTooltipExactNoWindow: "Uso exato informado pelo modelo: {used} tokens. O tamanho da janela de contexto é desconhecido.",
    contextMeterTooltipEstimate: "Estimado a partir do contexto selecionado mais as mensagens deste chat (~4 caracteres por token). O modelo não informou o uso exato, então nenhuma porcentagem é exibida.",
    contextPreviewTitle: "Na janela de contexto",
    contextPreviewTotal: "~{tokens} tokens · {chars} caracteres",
    contextPreviewSources: "Fontes ({count})",
    contextPreviewNotes: "Notas ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "Insights",
    contextPreviewModeFull: "Completo",
    contextPreviewInsight: "Insight",
    contextPreviewUntitledSource: "Fonte sem título",
    contextPreviewUntitledNote: "Nota sem título",
    contextPreviewEmpty: "Nada na janela de contexto. Ative fontes ou notas no contexto para incluí-las aqui.",
    contextPreviewBuilding: "Montando prévia do contexto…",
    contextPreviewApproxNote: "Os tamanhos de token por item são aproximados.",
    contextForThisChat: "Contexto para este chat",
    resetToNotebookDefault: "Redefinir para o padrão do notebook",
    inheritingNotebookDefault: "Herdando o contexto padrão do notebook",
    contextIncludedCount: "{count} incluídos",
    sessions: "Sessões",
    ...
    modelGroupLocal: "Modelos locais e outros",
  ...
  jobs: {
    tray: {
      ...
      finished: "Concluídas recentemente",
      clearFinished: "Limpar concluídas",
      lingerNote: "Itens concluídos somem em instantes",
    },
    kind: {
      chat: "Chat",
      podcast: "Gerando podcast",
      source: "Lendo fonte",
      embed: "Indexando para busca",
      chapters: "Construindo capítulos",
      verify: "Revisando páginas",
      summarize: "Resumindo capítulo",
    ...
    finishedToast: "{job} concluída",
    failedToast: "{job} falhou",
    view: "View",
  },
  console: {
    ...
    activity: "Atividade",
    context: "Contexto",
    goToOrigin: "Ir para a origem",
    empty: "Ainda sem atividade",
    emptyContext: "Nenhum contexto capturado para esta tarefa",
    thinking: "Pensando",
    warning: "Aviso",
    truncated: "Eventos mais antigos foram removidos",
    chars: "{count} caracteres",
    contextArgs: "Contexto enviado",
    contextMessage: "Mensagem enviada",
    streaming: "Processando…",
    jobFailed: "Esta tarefa falhou",
  },
  activity: {
    title: "Atividade",
    subtitle: "Cada execução de agente em segundo plano, a mais recente primeiro. Selecione uma para reproduzir seu console.",
    empty: "Ainda sem tarefas",
    emptyFiltered: "Nenhuma tarefa corresponde a este filtro",
    undated: "Sem data",
    jobCount: "{count} tarefas",
    refresh: "Atualizar",
    filter: {
      all: "Todas",
      failed: "Com falha",
