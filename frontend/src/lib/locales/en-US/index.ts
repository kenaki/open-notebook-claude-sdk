export const enUS = {
  ...
  gallery: {
    ...
    deleteBody: "\"{title}\" and all of its messages will be permanently deleted. This action can't be undone.",
  },
  ...
  notebooks: {
    ...
    loadError: "Couldn't load this notebook",
    loadErrorDesc: "Something went wrong while loading this notebook. Check your connection and try again.",
    updated: "Updated",
  ...
  sources: {
    ...
    parse: {
      ...
      reprocessTitle: "Re-process this document?",
      reprocessConfirm: "This re-runs the document parser and rebuilds the block layout — equations, figures and tables. Existing highlights are re-anchored automatically. It may take a few minutes.",
      reprocessQueued: "Re-processing started",
      reprocessFailed: "Failed to start re-processing",
      statusQueued: "Queued",
      statusParsing: "Parsing…",
      statusEmbedding: "Embedding…",
      statusReady: "Parsed",
      statusFailed: "Parse failed",
      statusNotParsed: "Not parsed",
      workingTip: "Building the document's block layout (equations, figures, structure)…",
      readyTip: "Parsed with {parser} · generation {gen}",
      failedTip: "Parsing failed. Try re-processing.",
      notParsedTip: "This document hasn't been parsed into blocks yet. Re-process to enable structure-aware highlights and the reader.",
    ...
    annotations: {
      ...
      anchorStale: "Stale",
      anchorLegacy: "Legacy",
      anchorAnchoredTip: "Anchored to the current parsed layout of this document.",
      anchorStaleTip: "This document was re-parsed after the highlight was made; its anchor may be out of date.",
    ...
    rawContent: {
      ...
      title: "Raw content",
      description: "The extracted text this source contributes to AI chat, search, and embeddings.",
    },
    reader: {
      tab: "Reader",
      pageNavLabel: "Page number",
  ...
  chat: {
    ...
    annotationRefEmpty: "Highlight",
    annotationRefPage: "p.{page}",
    annotationRefFigure: "Figure",
    jumpToHighlight: "Jump to highlight",
    recallRelated: "Related to earlier study",
    recallRefPage: "p.{page}",
    recallOpenSession: "Open that chat",
    recallJumpToHighlight: "Jump to highlight",
    recallKindExchange: "Past discussion",
    recallKindAnnotation: "Your highlight",
    ...
    askDraft: {
      attached: "{count} highlight(s) attached",
      attachedQuote: "Passage added to the prompt",
      newChat: "New chat",
      newChatReady: "Sending to a new chat",
      dismiss: "Remove attachment",
    },
    chatAboutThis: "Chat about this",
    explain: "Explain",
    saveNote: "Save note",
    discussingPassage: "Discussing this passage",
    ...
    searchedYourSources: "Searched your sources",
    readSources: "Read source",
    readNote: "Read note",
    readNotebook: "Read notebook",
    usedTool: "Used a tool",
    searchingYourSources: "Searching your sources…",
    readingSources: "Reading source…",
    ...
    emptyHelper: "Ask questions, summarize your sources, or explore ideas across this notebook.",
    suggestionSummarize: "Summarize the key points across my sources",
    suggestionQuestions: "What questions do these sources raise?",
    suggestionConnections: "Find connections between my notes",
    meterSources: "{count} sources",
    meterNotes: "{count} notes",
    meterTokens: "{count} tokens",
    contextMeterLabel: "Context usage",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "{used} tokens used",
    contextMeterEstimate: "~{used} tokens in context",
    contextMeterTooltipExact: "Exact usage reported by the model: {used} of {window} tokens ({percent}%).",
    contextMeterTooltipExactNoWindow: "Exact usage reported by the model: {used} tokens. Its context window size is unknown.",
    contextMeterTooltipEstimate: "Estimated from the selected context plus this chat's messages (~4 characters per token). The model has not reported exact usage, so no percentage is shown.",
    contextPreviewTitle: "In the context window",
    contextPreviewTotal: "~{tokens} tokens · {chars} chars",
    ...
    contextPreviewModeFull: "Full",
    contextPreviewInsight: "Insight",
    contextPreviewUntitledSource: "Untitled source",
    contextPreviewUntitledNote: "Untitled note",
    contextPreviewEmpty: "Nothing is in the context window. Toggle sources or notes into context to include them here.",
    contextPreviewBuilding: "Building context preview…",
    contextPreviewApproxNote: "Per-item token sizes are approximate.",
    contextForThisChat: "Context for this chat",
    resetToNotebookDefault: "Reset to notebook default",
    inheritingNotebookDefault: "Inheriting the notebook's default context",
    contextIncludedCount: "{count} included",
    sessions: "Sessions",
    ...
    modelGroupLocal: "Local & other models",
  ...
  jobs: {
    tray: {
      ...
      lingerNote: "Finished items clear shortly",
    },
    kind: {
      chat: "Chat",
      podcast: "Generating podcast",
      source: "Reading source",
      embed: "Indexing for search",
      chapters: "Building chapters",
      verify: "Proofing pages",
  ...
  console: {
    ...
    activity: "Activity",
    context: "Context",
    goToOrigin: "Go to origin",
    empty: "No activity yet",
    emptyContext: "No context captured for this job",
    thinking: "Thinking",
    warning: "Warning",
    truncated: "Older events were trimmed",
  ...
  activity: {
    title: "Activity",
    subtitle: "Every background agent run, newest first. Select one to replay its console.",
    empty: "No jobs yet",
