export const ruRU = {
  ...
  gallery: {
    ...
    noResults: "Нет чатов, соответствующих запросу.",
    editTags: "Изменить теги",
    tagInputPlaceholder: "Добавить тег…",
    clearFilters: "Сбросить фильтры",
    viewGrid: "Вид сеткой",
    viewList: "Вид списком",
    deleteChat: "Удалить чат",
    deleteTitle: "Удалить этот чат?",
    deleteBody: "«{title}» и все его сообщения будут удалены безвозвратно. Это действие нельзя отменить.",
  },
  ...
  notebooks: {
    ...
    loadError: "Не удалось загрузить этот блокнот",
    loadErrorDesc: "При загрузке этого блокнота произошла ошибка. Проверьте подключение и попробуйте снова.",
    updated: "Обновлено",
  ...
  sources: {
    ...
    parse: {
      ...
      reprocessTitle: "Переобработать этот документ?",
      reprocessConfirm: "Это повторно запустит парсер документа и заново построит блочную структуру — формулы, рисунки и таблицы. Существующие выделения будут привязаны заново автоматически. Это может занять несколько минут.",
      reprocessQueued: "Переобработка запущена",
      reprocessFailed: "Не удалось запустить переобработку",
      statusQueued: "В очереди",
      statusParsing: "Обработка…",
      statusEmbedding: "Создание эмбеддингов…",
      statusReady: "Обработан",
      statusFailed: "Ошибка обработки",
      statusNotParsed: "Не обработан",
      workingTip: "Построение блочной структуры документа (формулы, рисунки, структура)…",
      readyTip: "Обработан с помощью {parser} · поколение {gen}",
      failedTip: "Не удалось обработать. Попробуйте переобработать.",
      notParsedTip: "Этот документ ещё не разобран на блоки. Переобработайте, чтобы включить выделения с учётом структуры и режим чтения.",
      unknownParser: "неизвестный парсер",
    },
    annotations: {
      title: "Highlights",
      ...
      anchorAnchored: "Привязано",
      anchorStale: "Устарело",
      anchorLegacy: "Прежнее",
      anchorAnchoredTip: "Привязано к текущей разобранной структуре этого документа.",
      anchorStaleTip: "Документ был повторно обработан после создания выделения; привязка может быть устаревшей.",
    ...
    rawContent: {
      ...
      description: "Извлечённый текст, который этот источник передаёт ИИ-чату, поиску и эмбеддингам.",
    },
    reader: {
      tab: "Читалка",
      pageNavLabel: "Номер страницы",
      pageOfCount: "из {count}",
  ...
  chat: {
    ...
    annotationRefEmpty: "Выделение",
    annotationRefPage: "с. {page}",
    annotationRefFigure: "Рисунок",
    jumpToHighlight: "Перейти к выделению",
    recallRelated: "Связано с предыдущим изучением",
    recallRefPage: "с. {page}",
    recallOpenSession: "Открыть тот чат",
    recallJumpToHighlight: "Перейти к выделению",
    recallKindExchange: "Предыдущее обсуждение",
    recallKindAnnotation: "Ваше выделение",
    ...
    askDraft: {
      attached: "Прикреплено выделений: {count}",
      attachedQuote: "Фрагмент добавлен в запрос",
      newChat: "Новый чат",
      newChatReady: "Будет отправлено в новый чат",
      dismiss: "Убрать вложение",
    },
    ...
    uploadFailed: "Не удалось загрузить вложение",
    suggestedFollowups: "Предлагаемые уточняющие вопросы",
    searchedYourSources: "Поиск по вашим источникам",
    readSources: "Источник прочитан",
    readNote: "Заметка прочитана",
    readNotebook: "Блокнот прочитан",
    usedTool: "Использован инструмент",
    searchingYourSources: "Идёт поиск по вашим источникам…",
    readingSources: "Чтение источника…",
    readingNote: "Чтение заметки…",
    ...
    emptyTitle: "Спросите об этом блокноте",
    emptyHelper: "Задавайте вопросы, обобщайте источники или исследуйте идеи по всему блокноту.",
    suggestionSummarize: "Обобщите ключевые моменты моих источников",
    suggestionQuestions: "Какие вопросы поднимают эти источники?",
    suggestionConnections: "Найдите связи между моими заметками",
    meterSources: "{count} источников",
    meterNotes: "{count} заметок",
    meterTokens: "{count} токенов",
    contextMeterLabel: "Использование контекста",
    contextMeterUsed: "{used} / {window}",
    contextMeterUsedNoWindow: "Использовано {used} токенов",
    contextMeterEstimate: "~{used} токенов в контексте",
    contextMeterTooltipExact: "Точное использование по данным модели: {used} из {window} токенов ({percent}%).",
    contextMeterTooltipExactNoWindow: "Точное использование по данным модели: {used} токенов. Размер контекстного окна неизвестен.",
    contextMeterTooltipEstimate: "Оценка на основе выбранного контекста и сообщений этого чата (~4 символа на токен). Модель не сообщила точное использование, поэтому процент не отображается.",
    contextPreviewTitle: "В окне контекста",
    contextPreviewTotal: "~{tokens} токенов · {chars} символов",
    contextPreviewSources: "Источники ({count})",
    contextPreviewNotes: "Заметки ({count})",
    contextPreviewItemTokens: "~{tokens}",
    contextPreviewModeInsights: "Инсайты",
    contextPreviewModeFull: "Полностью",
    contextPreviewInsight: "Инсайт",
    contextPreviewUntitledSource: "Источник без названия",
    contextPreviewUntitledNote: "Заметка без названия",
    contextPreviewEmpty: "В окне контекста ничего нет. Включите источники или заметки в контекст, чтобы они появились здесь.",
    contextPreviewBuilding: "Формирование предпросмотра контекста…",
    contextPreviewApproxNote: "Размеры токенов по элементам приблизительны.",
    contextForThisChat: "Контекст для этого чата",
    resetToNotebookDefault: "Сбросить к контексту блокнота по умолчанию",
    inheritingNotebookDefault: "Наследует контекст блокнота по умолчанию",
    contextIncludedCount: "Включено: {count}",
    sessions: "Сессии",
    ...
    modelGroupLocal: "Локальные и другие модели",
  ...
  jobs: {
    tray: {
      ...
      doneCount: "{count} завершено",
      working: "Выполняется",
      finished: "Недавно завершённые",
      clearFinished: "Очистить завершённые",
      lingerNote: "Завершённые элементы скоро исчезнут",
    },
    kind: {
      chat: "Чат",
      podcast: "Создание подкаста",
      source: "Чтение источника",
      embed: "Индексация для поиска",
      chapters: "Формирование глав",
      verify: "Проверка страниц",
      summarize: "Суммирование главы",
    ...
    finishedToast: "{job} завершено",
    failedToast: "{job} завершилось с ошибкой",
    view: "View",
  },
  console: {
    title: "Консоль агента",
    activity: "Активность",
    context: "Контекст",
    goToOrigin: "Перейти к источнику",
    empty: "Пока нет активности",
    emptyContext: "Для этой задачи контекст не зафиксирован",
    thinking: "Думает",
    warning: "Предупреждение",
    truncated: "Старые события были обрезаны",
  ...
  activity: {
    title: "Активность",
    subtitle: "Все фоновые запуски агента, новые сверху. Выберите один, чтобы воспроизвести его консоль.",
    empty: "Пока нет задач",
    emptyFiltered: "Нет задач, соответствующих этому фильтру",
    undated: "Без даты",
    jobCount: "{count} задач",
    refresh: "Обновить",
    filter: {
      all: "Все",
      failed: "Неудачные",
