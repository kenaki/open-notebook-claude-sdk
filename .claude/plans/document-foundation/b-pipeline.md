...
| B4 | Tiered get_context rewrite (the digestion fix) | ◐ | commit c6f6004 + fix 8c0b606 (wave5d 2026-07-02); get_context("long")→ tiered digest for chaptered sources, **full_text fallback for non-chaptered (Decision #21 RESOLVED, #12 honored)**; Notebook.get_context rewired; 215 pass. Only **LIVE no-balloon check parked** |
